...
Caso necessário, configure também o `DEBUG` e o `FLASK_APP`:
```bash
DEBUG=True
FLASK_APP=app.py
```
...
Este projeto ainda está em desenvolvimento. Algumas funcionalidades e tecnologias podem mudar à medida que o projeto evolui.
